...
class MakeInvestmentController extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        // try{
        //     $accounts_url = "https://api.sandbox.fortressapi.com/api/trust/v1/financial-institutions/accounts/".$identityId;
        ...
        // }
        // try{
        //     $member_identity_url = "https://api.sandbox.fortressapi.com/api/trust/v1/external-accounts/financial";
        //     $member_identity = Http::withToken($token_json['access_token'])->post(
        //     $member_identity_url,
        //     [
        //         'identityId' => $identityId,
        //         'memberGuid' => $member_id,
        //     ]);
        //     $member_identity =  json_decode((string) $verify_identity->getBody(), true);
        // }catch(Exception $error){
        //     return redirect()->route('dashboard');
        // }
